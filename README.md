...
To activate the virtual environment type in your terminal: venv\Scripts\activate

After that install the required packages by typing "pip install -r requirements.txt"
